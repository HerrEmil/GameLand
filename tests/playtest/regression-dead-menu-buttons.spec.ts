...
const IMPLEMENTED_TARGETS = ["bear-hunt", "game2", "game3", "game4", "snake", "road-cross", "dash-run", "sky-hopper", "tile-2048", "star-blaster", "tetra", "missile-command", "astro-drift", "high-scores"];
